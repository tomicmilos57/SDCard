...
-- Equation(s):
-- \inst27|inst21|Equal0~0_combout\ = (\inst27|inst13|data\(1) & (\inst27|inst13|data\(0) & (\inst27|inst13|data\(2) & \inst27|inst13|data\(3))))
...
PORT MAP (
	...
	datad => \inst27|inst13|data\(3),
	combout => \inst27|inst21|Equal0~0_combout\);

-- Location: LCCOMB_X32_Y17_N8
\inst27|inst13|data[0]~8\ : cycloneiii_lcell_comb
-- Equation(s):
-- \inst27|inst13|data[0]~8_combout\ = ((\inst27|inst13|data\(8) & (\inst27|inst21|Equal0~1_combout\ & \inst27|inst21|Equal0~0_combout\))) # (!\inst27|inst13|data\(0))
...
-- Equation(s):
-- \inst27|inst13|data[1]~9_combout\ = (\inst27|inst13|data\(1) & (\inst27|inst13|data\(0) $ (VCC))) # (!\inst27|inst13|data\(1) & (\inst27|inst13|data\(0) & VCC))
-- \inst27|inst13|data[1]~10\ = CARRY((\inst27|inst13|data\(1) & \inst27|inst13|data\(0)))
...
-- Equation(s):
-- \inst28|inst7~0_combout\ = (\inst28|inst7~q\ & (((!\inst28|inst6|Equal0~1_combout\)))) # (!\inst28|inst7~q\ & (!\inst28|inst3|inst1~q\ & ((\inst27|inst21|Equal0~2_combout\))))
...
-- Equation(s):
-- \inst28|inst2~0_combout\ = (!\inst28|inst6|Equal0~1_combout\ & ((\inst28|inst7~q\) # ((!\inst28|inst3|inst1~q\ & \inst27|inst21|Equal0~2_combout\))))
...
-- Equation(s):
-- \inst28|inst5|data[0]~6_combout\ = \inst28|inst5|data\(0) $ (\inst28|inst2~0_combout\)
...
-- Equation(s):
-- \inst28|inst5|data[1]~7_combout\ = (\inst28|inst5|data\(1) & (\inst28|inst5|data\(0) $ (VCC))) # (!\inst28|inst5|data\(1) & (\inst28|inst5|data\(0) & VCC))
-- \inst28|inst5|data[1]~8\ = CARRY((\inst28|inst5|data\(1) & \inst28|inst5|data\(0)))
...
-- Equation(s):
-- \inst28|inst6|Equal0~0_combout\ = (\inst28|inst5|data\(1)) # ((\inst28|inst5|data\(0)) # ((\inst28|inst5|data\(2)) # (\inst28|inst5|data\(3))))
...
-- Equation(s):
-- \inst28|inst6|Equal0~1_combout\ = (\inst28|inst5|data\(4) & (\inst28|inst5|data\(6) & (!\inst28|inst5|data\(5) & !\inst28|inst6|Equal0~0_combout\)))
...
PORT MAP (
	clk => \inst5|inst|LPM_COUNTER_component|auto_generated|counter_reg_bit[6]~clkctrl_outclk\,
	asdata => \inst28|inst6|Equal0~1_combout\,
	sload => VCC,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \inst18|inst1~q\);
...
-- Equation(s):
-- \inst3|inst10|Equal0~0_combout\ = (((!\inst3|inst9|data\(1)) # (!\inst3|inst9|data\(2))) # (!\inst3|inst9|data\(0))) # (!\inst3|inst9|data\(3))
...
-- Equation(s):
-- \inst3|inst6~combout\ = (\inst3|inst10|Equal0~0_combout\ & (!\inst18|inst1~q\ & (\inst28|inst6|Equal0~1_combout\))) # (!\inst3|inst10|Equal0~0_combout\ & ((\inst3|inst6~0_combout\) # ((!\inst18|inst1~q\ & \inst28|inst6|Equal0~1_combout\))))
...
-- Equation(s):
-- \inst3|inst8~1_combout\ = (\inst3|inst8~0_combout\) # ((\inst28|inst6|Equal0~1_combout\ & (!\inst18|inst1~q\ & !\inst3|inst8~q\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst28|inst6|Equal0~1_combout\,
	datab => \inst18|inst1~q\,
	datac => \inst3|inst8~q\,
...
-- Equation(s):
-- \inst3|inst1|Y[39]~39_combout\ = (\inst3|inst|data\(40) & ((\inst18|inst1~q\) # (!\inst28|inst6|Equal0~1_combout\)))
...
-- Equation(s):
-- \inst3|inst1|Y[37]~37_combout\ = (\inst3|inst|data\(38) & ((\inst18|inst1~q\) # (!\inst28|inst6|Equal0~1_combout\)))
...
-- Equation(s):
-- \inst3|inst1|Y[31]~31_combout\ = (\inst3|inst|data\(32) & ((\inst18|inst1~q\) # (!\inst28|inst6|Equal0~1_combout\)))
...
-- Equation(s):
-- \inst3|inst1|Y[28]~28_combout\ = (\inst3|inst|data\(29) & ((\inst18|inst1~q\) # (!\inst28|inst6|Equal0~1_combout\)))
...
-- Equation(s):
-- \inst3|inst1|Y[27]~27_combout\ = (\inst3|inst|data\(28) & ((\inst18|inst1~q\) # (!\inst28|inst6|Equal0~1_combout\)))
...
-- Equation(s):
-- \inst3|inst1|Y[26]~26_combout\ = (\inst3|inst|data\(27) & ((\inst18|inst1~q\) # (!\inst28|inst6|Equal0~1_combout\)))
...
-- Equation(s):
-- \inst3|inst1|Y[25]~25_combout\ = (\inst3|inst|data\(26) & ((\inst18|inst1~q\) # (!\inst28|inst6|Equal0~1_combout\)))
...
-- Equation(s):
-- \inst3|inst1|Y[24]~24_combout\ = (\inst3|inst|data\(25) & ((\inst18|inst1~q\) # (!\inst28|inst6|Equal0~1_combout\)))
...
-- Equation(s):
-- \inst3|inst1|Y[23]~23_combout\ = (\inst3|inst|data\(24) & ((\inst18|inst1~q\) # (!\inst28|inst6|Equal0~1_combout\)))
...
-- Equation(s):
-- \inst3|inst1|Y[22]~22_combout\ = (\inst3|inst|data\(23) & ((\inst18|inst1~q\) # (!\inst28|inst6|Equal0~1_combout\)))
...
-- Equation(s):
-- \inst3|inst1|Y[18]~18_combout\ = (\inst3|inst|data\(19) & ((\inst18|inst1~q\) # (!\inst28|inst6|Equal0~1_combout\)))
...
-- Equation(s):
-- \inst3|inst1|Y[4]~4_combout\ = (\inst3|inst|data\(5)) # ((\inst28|inst6|Equal0~1_combout\ & !\inst18|inst1~q\))
...
-- Equation(s):
-- \inst30~1_combout\ = (\inst27|inst21|Equal0~2_combout\ & ((\inst3|inst8~q\) # ((\inst28|inst7~q\) # (!\inst28|inst3|inst1~q\))))
...
-- Equation(s):
-- \inst6|Y[0]~0_combout\ = (\inst5|inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(6) & (\inst27|inst21|Equal0~1_combout\ & (\inst27|inst13|data\(8) & \inst27|inst21|Equal0~0_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst5|inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(6),
	datab => \inst27|inst21|Equal0~1_combout\,
...
-- Equation(s):
-- \inst22|inst110|Mux5~0_combout\ = (\inst22|inst37~0_combout\ & (\inst22|inst28~0_combout\ $ (((\inst22|inst34~0_combout\) # (!\inst22|inst31~0_combout\))))) # (!\inst22|inst37~0_combout\ & (!\inst22|inst31~0_combout\ & (\inst22|inst34~0_combout\ & 
-- !\inst22|inst28~0_combout\)))
...
-- Equation(s):
-- \inst22|inst113|Mux0~0_combout\ = (\inst22|inst43~0_combout\ & (!\inst22|inst46~0_combout\ & (\inst22|inst40~0_combout\ $ (!\inst22|inst49~0_combout\)))) # (!\inst22|inst43~0_combout\ & (\inst22|inst49~0_combout\ & (\inst22|inst40~0_combout\ $ 
...
-- Equation(s):
-- \inst22|inst113|Mux2~0_combout\ = (\inst22|inst40~0_combout\ & (\inst22|inst43~0_combout\ & ((\inst22|inst46~0_combout\) # (!\inst22|inst49~0_combout\)))) # (!\inst22|inst40~0_combout\ & (\inst22|inst46~0_combout\ & (!\inst22|inst43~0_combout\ & 
